...
func _initialize_levels_data() -> void:
	...
	levels_data.append(LevelInfo.new(
		...
		"🎯 Задача: набери 42 очка и построить башню из пончиков",
		42,
	...
	levels_data.append(LevelInfo.new(
		...
		"🎯 Задача: набери 45 очков и докажи, что ты мастер балансировки!",
		45,
	...
	levels_data.append(LevelInfo.new(
		...
		"🎯 Задача: набери 30 очков, несмотря на ветер и спешку.",
		30,
